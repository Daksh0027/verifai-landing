...
const LoginModal = ({ isOpen, onClose, onSwitchToSignup, onUserRoleSelected, onReviewerRoleSelected }) => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Login submitted:', { email, password, role: selectedRole });
  ...
  const handleGoogleLogin = () => {
    // Handle Google login - will also need role selection
          ...
          <div className="login-modal-right">
            {step === 1 ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="login-form login-role-form">
