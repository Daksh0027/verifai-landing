...
export const LiquidChrome = ({
  ...
  useEffect(() => {
    ...
    try {
      renderer = new Renderer({ antialias: true, alpha: false });
      gl = renderer.gl;
  ...
  if (hasError) {
    return (
      <div ref={containerRef} className="liquidChrome-container liquidChrome-fallback" {...props}>
        <div className="liquidChrome-gradient"></div>
      </div>
    );
  }
